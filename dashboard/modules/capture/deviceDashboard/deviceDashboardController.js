...
angular.module("senta-capture")
    .controller('DeviceDashboardController', ["$scope", "$rootScope", function ($scope, $rootScope) {
// white
...
// };
        ...
        var handleGenerateGraph = function (animationOption) {
            ...
            var ctx6 = document.getElementById('pie-chart_first').getContext('2d');
            window.myPie = new Chart(ctx6).Pie(pieData, {
                animation: animationOption
            });

            var ctx7 = document.getElementById('pie-chart_second').getContext('2d');
            window.myPie = new Chart(ctx7).Pie(pieData, {
                animation: animationOption
            });
